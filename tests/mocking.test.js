...
describe("renderPage", () => {
  ...
  it("should cal lanalytics", async () => {
    const result = await renderPage();
...
describe("submitOrder", () => {
  ...
  it("should return failed if payment is unsuccessful", async () => {
...
describe("isOnline", () => {
  it("should retur false if current hour is outside opening hours", () => {
...
describe("getDiscount", () => {
  it("should return .2 on Ramadan day", () => {
